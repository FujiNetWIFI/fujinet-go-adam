# FujiNet Go Adam — Google Play submission checklist
...
1. Play Console → Create app — name "FujiNet Go Adam", App, Free.
...
- Description: reuse the repo README / zapstore.yaml copy. Must include:
  - a link to https://github.com/FujiNetWIFI/fujinet-go-adam (GPL source offer), and
  - ROM wording: "System ROMs are NOT included; users import their own OS7/EOS/WP dumps on first run."
...
- Privacy policy URL: https://fujinetwifi.github.io/fujinet-go-adam/
...
- **Foreground service — FGS_SPECIAL_USE declaration**. Justification (matches
  ...
  "Runs the Coleco ADAM emulator and the FujiNet network bridge while the
